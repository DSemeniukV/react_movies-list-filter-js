...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://https://github.com/DSemeniukV/react_movies-list-filter-js.github.io/react_movies-list-filter-js/) and add it to the PR description.
